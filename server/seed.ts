  ...
  try {
    ...
    await db.insert(arenas).values([
      // MAINSTREAM ARENAS (8)
      {
        ...
        icon: "Brain",
        color: "#7C3AED",
        imageUrl: "https://images.unsplash.com/photo-1677442d019cecf3da12172d10e3066faf3d831f3?w=800&h=400&fit=crop",
      ...
      },
      {
        ...
        icon: "Smartphone",
        color: "#F97316",
        imageUrl: "https://images.unsplash.com/photo-1512941691920-25bde6cbf335?w=800&h=400&fit=crop",
        category: "Programming",
        difficulty: "all",
        activeUsers: 2100,
        totalMissions: 78,
      },
      {
        ...
        icon: "Shield",
        color: "#10B981",
        imageUrl: "https://images.unsplash.com/photo-1550751827-4bd582f6de8c?w=800&h=400&fit=crop",
        category: "Security",
        difficulty: "all",
        activeUsers: 1890,
        totalMissions: 92,
      ...
      // RARE/NICHE TECHNOLOGIES (9+)
      {
        ...
        icon: "Zap",
        color: "#DC2626",
        imageUrl: "https://images.unsplash.com/photo-1635070041078-e5b94039d226?w=800&h=400&fit=crop",
        category: "Science",
        difficulty: "expert",
        activeUsers: 145,
        totalMissions: 34,
      },
      {
        ...
        icon: "Calculator",
        color: "#2563EB",
        imageUrl: "https://images.unsplash.com/photo-1599050158471-f0e6a9b0c4a5?w=800&h=400&fit=crop",
        category: "Science",
        difficulty: "expert",
        activeUsers: 210,
        totalMissions: 42,
      ...
      },
      {
        ...
        icon: "Zap",
        color: "#9333EA",
        imageUrl: "https://images.unsplash.com/photo-1606925945127-38c1f7e0a862?w=800&h=400&fit=crop",
      ...
      },
      {
        ...
        icon: "Dna",
        color: "#DC2626",
        imageUrl: "https://images.unsplash.com/photo-1576091160550-112173e7d7cb?w=800&h=400&fit=crop",
        category: "Science",
        difficulty: "expert",
        activeUsers: 134,
        totalMissions: 32,
